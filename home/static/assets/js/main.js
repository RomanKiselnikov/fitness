...
const service_type = document.querySelector("#service_type")

const service_type_btns = document.querySelectorAll(".service_type_btn")

for(let service_btn of service_type_btns){
  service_btn.onclick = ()=>{
    service_type.value = service_btn.getAttribute("data-name")
  }
}
